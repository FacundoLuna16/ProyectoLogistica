...
public class HojaDelDiaExepcional {
    ...
    public HojaDelDiaExepcional(List<Envio> envios,EstadoHoja estadoHojaDelDia) {
    ...
    public HojaDelDiaExepcionalEntity toEntity() {
        HojaDelDiaExepcionalEntity hojaDelDiaEntity = new HojaDelDiaExepcionalEntity();
        hojaDelDiaEntity.setIdHojaDelDiaExepcional(idHojaDelDiaExepcional);
